...
function getData(func) {
  ...
  _papaparse.default.parse(_data.default, {
    delimiter: ";",
    header: true,
    download: true,
    complete: function complete(results) {
      var datos = results.data; //console.log('Our CSV data apres Papa', datos);

      var dataInFormat = putDataInFormat(datos); //console.log('Our CSV data apres format', dataInFormat);
...
function putDataInFormat(datos) {
  ...
  for (var i = 0; i < datos.length; ++i) {
    var article = newArticle(datos[i].name, datos[i].size); //Domains

    var domainOfI = get(domains, datos[i].domain); //console.log(domainOfI,domains,datos[i]);
...
},{"papaparse":"node_modules/papaparse/papaparse.min.js","./data.csv":"data.csv"}],"node_modules/d3/d3.js":[function(require,module,exports) {
var define;
!function() {
  var d3 = {
    version: "3.5.17"
...
function principal() {
  (0, _store.getData)(createGraph);
}

var color = _d.default.scale.category10();
...
function createGraph(treeData) {
  ...
  update, zoom;
  console.log('Our CSV data in index', treeData); // ************** Generate the tree diagram     *****************

  window.current_nodes = [];

  update = function update(source) {
    var link, links, node, nodeEnter, nodeExit, nodeUpdate, nodes; // Compute the new tree layout.
  ...
  construct_generations = function construct_generations(d) {
    var c, generations;
  ...
  reform_focus = function reform_focus() {
    var count, d, set;
  ...
  store_and_update = function store_and_update(d) {
    window.current_nodes.push([d, construct_generations(d)]);

    while (d.parent) {
      // Back up original tree
      d.parent._children = d.parent.children; // Filter out non line of site children

      d.parent.children = [_underscore.default.find(d.parent.children, function (e) {
  ...
  reconstruct_ancestors = function reconstruct_ancestors(n, generations) {
    var count;
  ...
  radius = diameter / 2;
  root = void 0;
  tree = _d.default.layout.tree().size([360, radius - 120]);
  i = 0;
  duration = 2000;
  diagonal = _d.default.svg.diagonal.radial().projection(function (d) {
    return [d.y, d.x / 180 * Math.PI];
  });

  zoom = function zoom() {
    return svg.attr("transform", "translate(" + _d.default.event.translate + ")scale(" + _d.default.event.scale + ")");
  };

  div = _d.default.select("#focus");
  svg = div.insert("svg").attr("viewbox", "0 0 " + diameter / 2 + "," + diameter / 2).attr("width", "900px").attr("height", "100%").append("g").attr("transform", "translate(" + diameter / 2 + "," + diameter / 2 + ")").append("g").call(_d.default.behavior.zoom().scaleExtent([1, 8]).on("zoom", zoom));
  root = treeData[0];
  root.x0 = height / 2;
  root.y0 = 0;
  update(root);
}
},{"./store":"store.js","d3":"node_modules/d3/d3.js","jquery":"node_modules/jquery/dist/jquery.js","underscore":"node_modules/underscore/underscore.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/projetDataViz.e31bb0bc.map